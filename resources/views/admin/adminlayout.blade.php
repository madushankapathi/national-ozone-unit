...
{{--    <a class="{{ $activePage === '/home' ? 'active' : '' }}" href="{{ url('/home') }}">User request</a>--}}
    <a class="@yield('user-request')" href="{{ url('/home') }}">User request</a>
    <a class="@yield('user-details')" href="{{ url('/userDetails') }}">User details</a>
