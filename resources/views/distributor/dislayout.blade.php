<x-app-layout>
    ...
    <body>
    <div class="sidebar">
        <a class="@yield('dis-trans')" href="{{ url('/home') }}">New transaction</a>
        <a class="@yield('dis-his')" href="{{ url('/disHistory') }}">Transaction history</a>
        <a class="@yield('dis-add-his')" href="{{ url('/disGasAddHistory') }}">Gas Add history</a>
    </div>
